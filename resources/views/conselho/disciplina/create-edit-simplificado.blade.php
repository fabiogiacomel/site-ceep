...
<form method="post" action="{{route('conselho-disciplina.update', ['id'=> $disciplina ->id])}}" enctype="multipart/form-data">
    ...
    {{ csrf_field() }}
        ...
        <div class="row">
           <div class='col'>
               <input type='radio' name='turma' value='1' required><label for='curso'> Turma A (Manhã)</label>
            </div> 
            <div class='col'>
            ...
            <div class='col'>
                <input type='radio' name='turma' value='3' required><label for='curso'> Turma C (Tarde)</label>
            </div> 
            <div class='col'>
        ...
        <div class='form-group'>
            ...
            <input type="text" name='disciplina' value='{{$disciplina->descricao ?? old("descricao") }}' class='form-control'/>
        </div>
        <div class='form-group'>
