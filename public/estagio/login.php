...
<br>	
	...
	foreach($dados as $linha){
		echo "<div class='vaga'>";
		echo "<h2>".$linha['curso']."</h2>";
		echo "<h1>R$ ".$linha ['bolsa_auxilio']."</h1>";
		echo "<h3>VAGA: ".$linha ['empresa']."</h3>";
		echo "<h4>SETOR: ".$linha ['setor']."</h4>";
			echo "<p>Incluído em: ".inverteData($linha ['data'])."</h4>";
		echo "</div>";
	}
	?>
	</table>
